 ...
 ******************************************************************************/
     ...
     */
    userDir: 'D:/services/node-red/userdata',
 ...
 ******************************************************************************/
     ...
     */
    fileWorkingDirectory: 'D:\services\node-red\workspace',
...
# Ajoute le fichier settings.js
Set-Content -Path (Join-Path $nodered "settings.js") -Value $settings_js

# Donne plein acces aux utilisateurs nodered et francois
$Account = [System.Security.Principal.NTAccount]"nodered"
